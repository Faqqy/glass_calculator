// Цены на тип стекла за м^2, указаны по таблицам Excel по табличным же толщинам:
// 2мм, 3мм, 4мм, 5мм, 6мм, 8мм, 10мм, 12мм, 15мм, 19мм 
//
// Типы стёкол:
// М1, сатинато, бронза, оптивайт, бронза сатинато, серое в массе, давальческое
//
// 'null' ставятся там где нет табличных значений цены
const glass_prices = {
    "glass-type-m1": [
